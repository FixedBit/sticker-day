#!/usr/bin/env bash
PORT=$(cat "/home/jason/sticker-day/.dual-graph/run/claude/mcp_port" 2>/dev/null || echo 8080)
...
if [[ -f "/home/jason/sticker-day/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/home/jason/sticker-day/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject AUDIT_CONTEXT.md if recent (< 7 days) — tells Claude what to fix
AUDIT_CTX="/home/jason/sticker-day/.dual-graph/AUDIT_CONTEXT.md"
if [[ -f "$AUDIT_CTX" ]]; then
...
STORE="/home/jason/sticker-day/.dual-graph/context-store.json"
